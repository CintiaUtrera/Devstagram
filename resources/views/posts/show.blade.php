...
@section('contenido')
    <div class="container m-5 md:flex">
        <div class="md:w-1/2">
        ...
        <div class="md:w-1/2 p-5">
            <div class="shadow bg-white p-5 mb-5">
                ...
                @if (session('mensaje'))
                    <div class="bg-green-500 p-2 rounded-lg mb-6 font-bold text-white text-center uppercase">
                        {{session('mensaje')}}
                    </div>
                @endif
                <form action="{{route('comentarios.store', ['post'=> $post, 'user'=> $user])}}">
                    ...
                    <textarea id="comentario" name="comentario" class="border p-3 w-full rounded-lg @error('comentario') border-red-500 @enderror">
